...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> 图书管理系统欢迎您！！！</h1>
          <p>welcome to our Book Management System</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
          <li class="breadcrumb-item">首页</li>
          <li class="breadcrumb-item active"><a href="#">退出</a></li>
        </ul>
      </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              <div style="float:left;" align="left"><button type="button" class="btn btn-warning" onclick="toAddPage()">增加图书</button>
                <button type="button" class="btn btn-danger" onclick="deleteAll()">全部删除</button></div>
   ...
   <%-- <script type="text/javascript" src="js/plugins/dataTables.bootstrap.min.js"></script>
    ...
    <script type="text/javascript">
      $(function () {
          $("#mytable").bootstrapTable({
              ...
              columns: [
                  ...
                  return "<button class='btn btn-info' onclick='editBook("+row.bid+")'>编辑</button>" +
                          "<button class='btn btn-danger' onclick='removeBook("+row.bid+")'>删除</button>";
                  }
              }],
             /* //要绑定的参数
              data: [{
              ...
              //如果使用服务器端分页，传过来的数据需要是{rows:98, rows:[{},{}]}
              url:"users",
      ...
      function editBook(bid) {
          location.href = "editBook.do?bid="+bid;
      }
      ...
      function deleteUser(ids) {
          if (confirm("您真的确定要删除吗？")){
              var url = "deleteAllSelected?ids="+ids;
              $.post(url,function () {
                  alert("删除成功！")
                  window.location.reload();
              })
